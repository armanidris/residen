                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                    @csrf
                                <input type="hidden" name="ujian_id" value="">
                                <input type="hidden" name="res_id" value="{{ session('res_id') }}">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" required  id="ujian_name" name="ujian_name" class="form-control" placeholder="Masukkan nama ujian yang diikuti" value="{{ old('ujian_name') }}">
                                                </div>
                                                @error('ujian_name')
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text"  required  id="tempat" name="tempat" class="form-control" placeholder="Tempat ujian" value="{{ old('tempat') }}">
                                                </div>
                                                @error('tempat')
                                                    <small><p class="col-pink"> {{ $message }} </p></small>
                                                @enderror
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group" id="bs_datepicker_container">
                                                    <div class="form-line">
                                                        <input  required autocomplete="off" type="text"  name="tanggal" class="form-control" placeholder="Tanggal ujian..." value="{{ old('tanggal') }}">
                                                    </div>
                                                    @error('tanggal')
                                                        <small><p class="col-pink"> {{ $message }} </p></small>
                                                    @enderror
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-2">
                                            <input name="ket" type="checkbox" value="1" id="ket">
                                            <label for="ket"></label>
                                        </div>
                                    </div>								
                                    <div class="row clearfix">
