...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Residen Bedah</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link {{ count(Request::segments()) < 1 ? "active":"" }}" aria-current="page" href="/">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ (Request::segment(1)=="residen" ? "active":"") }}" href="/residen/pshow">Residen</a>
              </li>
